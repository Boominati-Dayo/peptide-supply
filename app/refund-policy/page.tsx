            ...
            <div className="prose prose-blue max-w-none text-gray-600 space-y-8">
                <section>
                    <p className="text-lg leading-relaxed">
                        At <span className="font-bold text-dark">PeptideMint</span>, we take pride in providing only the highest-quality research peptides. Due to the sensitive nature of our products, all payments made to us are non-refundable.
                    </p>
                    <p className="mt-4">
                ...
                <section>
                    ...
                    <p>
                        Payments made to PeptideMint are non-refundable under normal circumstances.
                    ...
                    <p className="mt-4 italic">
                        If you have concerns or disputes regarding charges, you agree to contact PeptideMint directly before initiating any chargeback or cancellation request. Attempting to dispute charges without first contacting us may result in suspension of future purchasing privileges.
                    </p>
                </section>

                <section>
                    <h2 className="text-2xl font-bold text-dark mb-4">2. Order Cancellations</h2>
                    <p className="mb-4">PeptideMint reserves the right to cancel or decline any order if:</p>
