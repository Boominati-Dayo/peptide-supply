            ...
            <div className="prose prose-blue max-w-none text-gray-600 space-y-10">
                <section>
                    <p className="text-lg leading-relaxed">
                        At <span className="font-bold text-dark">PeptideMint</span>, we are committed to protecting your privacy and ensuring a secure experience for all our users. This Global Privacy Policy explains how we collect, use, and safeguard your personal information.
                    </p>
                </section>
                ...
                <section>
                    ...
                    <p>
                        PeptideMint does <span className="font-bold text-dark italic">not</span> sell, trade, or rent your personal information to third parties. We only share necessary data with trusted service providers who assist us in operating our website, conducting our business, or servicing you (e.g., shipping carriers and payment processors), provided those parties agree to keep this information confidential.
                    </p>
                </section>
